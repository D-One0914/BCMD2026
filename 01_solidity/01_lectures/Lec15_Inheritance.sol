...
contract Lec15_Father{
    ...
    function getFamilyName() public pure virtual returns(string memory) {
        return "Kim";
    }
...
contract Lec15_Son2 is Lec15_Mother, Lec15_Father {
    ...
    function getFamilyName() public pure override(Lec15_Mother, Lec15_Father) returns(string memory) {
